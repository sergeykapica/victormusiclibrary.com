			...
			if($comment["SHOW_AS_HIDDEN"] == "Y" || $comment["PUBLISH_STATUS"] == BLOG_PUBLISH_STATUS_PUBLISH || $comment["SHOW_SCREENNED"] == "Y" || $comment["ID"] == "preview")
			{
				...
				if($comment["PUBLISH_STATUS"] == BLOG_PUBLISH_STATUS_PUBLISH || $comment["SHOW_SCREENNED"] == "Y" || $comment["ID"] == "preview")
				{
					...
					<div class="blog-comment-info">
						...
						{
							?>
                            <div class="blog-author-avatar" style="background-image: url(<?=$comment['AVATAR_file']['SRC'];?>);"></div>
					...
					<div class="blog-comment-content">
						...
						if($bCanUserComment===true)
						{
                            ...
                            <div class="comment-functions-icon functions-icon-reply"></div>
						...
						if($comment["CAN_EDIT"] == "Y")
						{
                            ...
                            <div class="comment-functions-icon functions-icon-edit"></div>
							<?
						}
						...
						if(strlen($comment["urlToHide"])>0)
						{
							...
							<span class="blog-comment-show">
                                ...
                                <div class="comment-functions-icon functions-icon-hide"></div>
							<?
						}
						if(strlen($comment["urlToDelete"])>0)
						{
							...
							<span class="blog-comment-delete">
                                ...
                                <div class="comment-functions-icon functions-icon-delete"></div>
							<?
						}
						if(strlen($comment["urlToSpam"])>0)
						{
                            ...
                            <div class="comment-functions-icon functions-icon-spam"></div>
							<?
						}
						if ($arParams["SHOW_RATING"] == "Y")
						{
...
if($arResult["CanUserComment"])
{
    ...
    <div class="blog-add-comment"><a class="bx_medium bx_bt_button" href="javascript:void(0)" onclick="return editCommentNew('0', <?=$arParams["ID"]?>)"><?=GetMessage("B_B_MS_ADD_COMMENT")?></a><br /></div>
    <a name="0"></a>
    <?
